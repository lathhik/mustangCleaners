            ...
            <div class="h-100 no-gutters row">
                        ...
                        <div class="slick-slider">
                            <div>
                                <div class="h-100 d-flex justify-content-center align-items-center bg-sunny-morning"
                                    ...
                                    <div class="slide-img-bg"
                                         style="background-image: url('{{asset('custom/backend/assets/images/originals/citydark.jpg')}}');"></div>
                                    <div class="slider-content"><h3>Mustang Cleaners Services</h3>
                                        <p>We Are The Best</p></div>
                                </div>
                            </div>
                            <div>
                                <div class="h-100 d-flex justify-content-center align-items-center bg-plum-plate"
                                     tabindex="-1">
                                    <div class="slide-img-bg"
                                         style="background-image: url('{{asset('custom/backend/assets/images/originals/city.jpg')}}');"></div>
                                    <div class="slider-content"><h3>Laundry Service</h3>
                                        <p>We Provide Laundry Service</p></div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="h-100 d-flex justify-content-center align-items-center bg-premium-dark"
                                     tabindex="-1">
                                    <div class="slide-img-bg"
                                         style="background-image: url('{{asset('custom/backend/assets/images/originals/citynights.jpg')}}');"></div>
                                    <div class="slider-content"><h3>Dry Cleaning Service</h3>
                                        <p>We Provide Dry Cleaning Service</p></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                    <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                        <div class="app-logo">
                            <img src="{{asset('custom/assets/images/logo.png')}}" style="height: 50px" alt="" class="logo-png">
                        </div>
                        <h4 class="mb-0">
