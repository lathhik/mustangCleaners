            ...
            <div class="h-100 no-gutters row">
                ...
                <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                    <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                        ...
                        <h4 class="mb-0">
                            <span class="d-block">Reset Your Password,</span></h4>
                        <div class="divider row"></div>
                        <div>
                            @include('messages.succFail')
                            <form class="" method="post" action="{{route('password-reset-action')}}">
                                @csrf
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="position-relative form-group"><label for="examplePassword" class="">New
                                    ...
                                    <div class="col-md-8">
                                        <div class="position-relative form-group"><label for="examplePassword" class="">Confirm
                                                Password</label><input
                                                name="password_confirmation" id="examplePassword"
                                ...
                                <div class="divider row"></div>
                                <button type="submit" class="btn btn-primary btn-lg float-right ml-2">Reset
                                </button>
